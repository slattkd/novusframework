...
<body style="height: 100vh">
    <div id="countdown-banner" class="flex justify-center flex-nowrap bg-redish text-white p-3 text-center text-sm hidden" style="position: sticky;top: 0;z-index: 1000; filter: saturate(1.8)">
    ...
    <header class="flex justify-center bg-lime-600 p-2">
        <div class="flex flex-wrap bg-white rounded px-2 md:px-4 py-1 text-greenish items-center text-center text-sm md:text-base">
                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <?php if ($csactive == 1) : ?>
                        <div class="flex flex-nowrap mx-auto items-center mt-2 md:mt-0">
                            ...
                            <span class="text-xs md:text-base">Call&nbsp;<a href="tel:<?= $company['phone_specialist']; ?>" class="no-underline"><?= $company['phone_specialist']; ?></a>&nbsp;Now To Speak To A Product Specialist!</span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            <div class="flex justify-center w-full mt-4 text-center">
                <h1 class="text-redish text-5xl font-bold condensed hidden md:block">Step 2: This Massive Discount Is Almost&nbsp;Yours...</h1>
                ...
                <div class="w-full px-0 md:px-4 my-4 lg:my-0 min-h-full order-last md:order-first">
                    <div class="border border-black p-4 px-5">
                        ...
                        <ul class="w-full" style="padding-left: 0">
                            ...
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2"><?= $company['featuredProduct']; ?> PLUS (<?php echo $productLabel; ?>)</div>
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold">$<?php echo $price; ?><span class="text-greenish font-bold ml-2 invisible">FREE!</span></div>
                            </li>
                            <?php if($add1pid !== 0): ?>
                                <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                    <div class="w-full md:w-2/3 mr-2">Super Lube (<?= $slQty; ?>)</div>
                                    <div class="flex flex-nowrap text-lg text-gray-400 font-semibold">$<?= $slTotal; ?> <span class="text-greenish font-bold ml-2 invisible">FREE!</span></div>
                                </li>
                            <?php endif; ?>
                            <?php if($add2pid !== 0): ?>
                                <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                    <div class="w-full md:w-2/3 mr-2">37 Sex Positions</div>
                                    <div class="flex flex-nowrap text-lg text-gray-400 font-semibold">$19.95 <span class="text-greenish font-bold ml-2 invisible">FREE!</span></div>
                                </li>
                            <?php endif; ?>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2">5G Enhancement Bible</div>
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><strike>$19.95</strike> <span class="text-greenish font-bold ml-2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2">The Multiplier Method</div>
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><strike>$49.00</strike> <span class="text-greenish font-bold ml-2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2">The XXL Formula</div>
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><strike>$79.95</strike> <span class="text-greenish font-bold ml-2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2">Magic Words That Drive Her Wild</div>
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><strike>$39.00</strike> <span class="text-greenish font-bold ml-2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                            ...
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                ...
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><strike>$39.95</strike> <span class="text-greenish font-bold ml-2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b flex-nowrap md:flex-wrap py-2">
                                <div class="w-full md:w-2/3 mr-2">Shipping</div>
                                <!-- shipping price updates with JS logic on render and shipping country change-->
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold"><span id="ship-price-display">6.95 </span> <span class="text-greenish font-bold ml-2" id="ship-free2">FREE!</span></div>
                            </li>
                            <li class="flex justify-between items-center border-b-0 flex-nowrap md:flex-wrap py-2">
                                ...
                                <div class="flex flex-nowrap text-lg text-gray-400 font-semibold">$ <span id="tax-amt">0.00</span><span class="text-greenish font-bold ml-2 invisible">FREE!</span></div>
                            </li>
                            <li class="flex justify-center items-center py-4 mt-4 hidden md:flex">
                                <div class="flex justify-center flex-wrap md:flex-nowrap text-lg font-semibold mx-auto md:mx-0">That's $266.86 of Bonus Gifts, <span class="text-greenish fw-bold mx-auto md:ml-2"> YOURS FREE!</span></div>
                            </li>
                            ...
                            <li class="flex justify-center items-center py-4 md:hidden">
                                <div class="flex justify-center flex-wrap md:flex-nowrap text-xl font-semibold mx-auto md:mx-0">That's $266.86 of Bonus Gifts, <span class="text-greenish fw-bold mx-auto md:ml-2"> YOURS FREE!</span></div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="flex items-center border-t hidden md:flex">
                        ...
                        <div class="text-greenish" style="color: #40a900!important;">
                            Try <?= $company['featuredProduct']; ?> PLUS <strong>Risk FREE</strong> Until <strong><?php echo $displayDeadline; ?></strong> With Our 90-Day Guarantee
                        </div>
                    </div>
                    ...
                    <div class="w-full ryan-yellow border p-5 my-5">
                        ...
                        <div class="flex flex-col">
                            ...
                            <img src="//<?= $_SERVER['HTTP_HOST']; ?>/images/90-day-icon.png" alt="90 day guarantee" class="w-5/12 md:w-auto -mb-22 md:mb-0 hidden md:block" style="max-width: 300px; float: right;">
                            - to try out <?= $company['featuredProduct']; ?> PLUS and make sure I love it. And any time I want, I can call support at <strong><?= $company['phone']; ?></strong> or email <strong><?= $company['email']; ?></strong>, 24 hours a day, 7 days a week to request a refund, with no questions asked and no hassles!
                            <br> <strong id="guarantee">GUARANTEED BY:</strong>
                            <img src="//<?= $_SERVER['HTTP_HOST']; ?>/images/90-day-icon.png" alt="90 day guarantee" class="w-5/12 md:w-auto -mb-22 md:mb-0 md:hidden" style="max-width: 300px; float: right;">
                            <br> <img src="//<?= $_SERVER['HTTP_HOST']; ?>/images/ryan-sign.png" alt="ryan signature" class="w-50 md:w-auto mt-8 " style="max-width: 200px;mix-blend-mode: darken;">
          ...
          <form action="/process.php<?php echo trim(@$querystring); ?>"  method='POST' id="step_1" class="col-sm-12">
                        ...
                        <section class="order-last md:order-first">
                            ...
                            <div class="flex flex-col w-full my-5 mt-1">
                                ...
                                <p class="text-center text-sm mt-2 hidden md:block">Credit Card charged as <strong>"<?= $company['billedAs']; ?>"</strong></p>
                            </div>
                            <div class="flex flex-wrap items-center mb-4">
                                <div class="w-full w-1/3">
                        ...
                        <section>
                            ...
                            <div class="flex flex-nowrap items-start justify-center w-full my-5 mt-3 ml-1">
                                <input type="checkbox" checked name="billingSameAsShipping" id="bill-same" style="outline: 1px solid gray; margin-top: 0.25rem" value="<?php echo @$_SESSION['billingSameAsShipping']; ?>"/>
                        ...
                        <section>
                            <div class="text-xl text-gray-600 md:hidden my-4 mb-1">
                                ...
                                <p class="mb-2">Bonuses  &nbsp; <strike id="bonuses">$266.85</strike> <span id="p2-free" class="text-greenish">FREE!</span></p>
                                <p class="flex flex-nowrap mb-2" >Shipping  &nbsp; <span id="ship-price-display2">6.95 </span> <span id="ship-free" class="text-greenish ml-1" style="display: none">FREE!</span></p>
                            ...
                            <div class="flex flex-col w-full items-center py-3">
                                ...
                                <div id="totalPricePay" class="flex w-full text-2xl items-center justify-center px-2 md:justify-between mb-4 md:mb-1" style="max-width: 450px;">
                                    ...
                                    <div class="flex items-center">
                                        <div id="totalPricePayValue" class=" text-redish font-semibold mx-2 md:hidden" style="color: #e36500">Just $<span id="total-mobile"><?php echo $totalPrice; ?></span> <span class="text-black">Today!</span></div>
                                        <div id="totalPricePayValue" class="font-semibold mx-2 hidden md:block">$<span id="total-desktop"><?php echo $totalPrice; ?></span></div>
                                        <div id="totalDiscount" class="hidden font-semibold text-redish md:block text-lg">(<?php echo $discount; ?>% OFF)</div>
                                    </div>
                                ...
                                <div class="flex w-full justify-center">
                                    <button type= name="next-button" id="next-button" class="w-full newbuy text-3xl hidden md:block" value="COMPLETE PURCHASE">Complete Purchase</button>
                                ...
                                <div class="flex flex-col w-full mt-3 md:hidden">
                                    ...
                                    <div class="flex mt-3">
                                        <img class="mx-auto w-full" src="//<?= $_SERVER['HTTP_HOST'];?>/images/sec-icons-new.png" style="max-width: 800px;">
                                    </div>
                                </div>
                    ...
                    <div class="flex justify-center my-2 hidden md:flex">
                        <div class="flex px-4 text-center text-sm">
                            <p>Buy with <strong>confidence</strong>. See real, <strong>positive</strong> reviews from customers who love <?= $company['featuredProduct']; ?>. We’re <strong>top-rated</strong> with over 30,000 happy customers around the world!</p>
                        </div>
                    </div>
            ...
            <div class="flex justify-center flex-wrap text-center mt-0 bg-black md:bg-white p-3 py-6 md:pb-8 mb-0" style="margin-left: -12px; margin-right: -12px;">
                <p class="text-center md:hidden py-3 text-gray-500">*These statements have not been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure, or prevent any disease. <?= $company['featuredProduct']; ?> should be used as a supplement to your active lifestyle.</p>
    ...
    <p class="">Your <?= $company["featuredProduct"]; ?> discount is no longer being held! Please <strong>choose your discount package now</strong> before your spot is given away to the next man in line...</p>
    ';
    $modal_footer = '
