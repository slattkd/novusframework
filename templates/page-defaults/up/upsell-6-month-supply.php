                    ...
                    <div id="order-section" class="hidden transition-all duration-500 ease-in-out">
                        ...
                        <div class="flex w-full flex-wrap justify-around border-2 border-red-600 border-dashed" >
                            <div class="flex flex-col justify-around p-4">
                                ...
                                <a href="/process-up.php?pid=11&buy=1&next=up/upsell-2-blow-her-away" id="upsell-buy" class="buy_button processlink" rel="samewin" onclick="exit=false;"><img class="mx-auto" src="//5gm.s3.amazonaws.com/yes-secure-my-discount.png" alt="Yes, Secure My Discount" style="max-width: 300px" /></a>
                                </div>
                            ...
                            <div class="flex flex-col justify-around p-4">
                                ...
                                <div class="flex justify-center mt-3">
                                <a href="/process-up.php?pid=250&buy=1&next=up/upsell-2-blow-her-away" id="upsell-buy" class="buy_button processlink" rel="samewin" onclick="exit=false;"><img class="mx-auto" src="//5gm.s3.amazonaws.com/yes-secure-my-discount.png" alt="Yes, Secure My Discount" style="max-width: 300px" /></a>
                                </div>
                            </div>
                        </div>
