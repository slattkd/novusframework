...
<body>
  <div class="wsl container-sm mx-auto">
    <div class="slpage">
      ...
      <div id="letter_body" class="p-2 py-6 md:px-0 md:w-full mt-6 flex flex-wrap">

        <div class="letter-body">

        <h1 class="text-center text-4xl md:text-5xl text-red-600 leading-6 title mb-0">WAIT!</h1>
        <h2 class="text-2xl md:text-4xl text-red-600 mb-4 title text-center mt-0">Due To High Demand And Limited Availability You <em>Must</em> Confirm That You Are Permanently 
        Giving Up Your Claim On This One-Time Only&nbsp;Deal:</h2>          

          <p class="my-8 w-full md:w-4/5 mx-auto p-3">
            <input type="checkbox" name="go_check" id="go_check9">&nbsp; I understand that this deal on <b> 5G Male,</b>
            including <b>2 exclusive bonuses</b> is ONLY offered to new customers of <b>5G Male</b> and is not available
            ANYWHERE but here. I also understand this deal is backed by an unheard of 90-day guarantee. I accept that by
            declining this offer I will give up my opportunity to access this discount for good.
          ...
          <div class='centered'>
            <p><a href="//<?php echo $_SERVER['HTTP_HOST']?>/dn/downsell-1"
                style="color: black; text-decoration: underline;font-weight:400;font-size: 14px;line-height:20px;"
                onClick="exit=false; var input = document.getElementById ('go_check9'); if (!input.checked ) alert('Please check the checkbox to continue.'); return input.checked;">Give
                My Reserved Space Away To Another Customer</a></p>
          </div>
          ...
          <div class="buttons-wrap">
            ...
            <div class="buttons-right centered mt-6 md:mt-0">
