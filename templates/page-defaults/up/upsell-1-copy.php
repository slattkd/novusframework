...
<body class="bg-gray-100 c8 wsl">
  ...
  <div class="container-vsl mx-auto flex my-4 md:my-8">
    <?php
        template("includes/step_bar", null, 2);
        ?>
  </div>
  <div class="container-vsl mx-auto my-2 bg-white border-2 p-4 md:p-8 mt-6 mb-11 rounded-lg content-center text-gray-600">
    ...
    <div class="flex flex-col items-center justify-center">
      <h6 class="bg-tygreen text-white p-2 py-1 mb-4 rounded">FREE BONUS REPORT FROM DR. MASLEY</h6>
    

      <h1 class="text-3xl md:text-5xl text-tygreen leading-6 title">
      ...
      <h5 class="text-xl md:text-2xl text-rpblue font-semibold mb-4 md:mb-6">While further <strong>reducing cravings,</strong> <strong>boosting energy
        ...
        your body… cleaning it out so it <span class="nw">burns fat</span> like an 8-cylinder engine in a Ferrari <span
          class="nw-all">at full speed!</span></h5>
    </div>
    ...
    <p><span
        style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 364.00px; height: 187.00px;"><img
          alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/upsell1/image1.jpg"
          style="width: 364.00px; height: 187.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
          title=""></span></p>
    <p><span class=" font-bold">[DESIGN: please re-create this graph and replace &ldquo;curcumin&rdquo; with
        &ldquo;Total Brain Boost ingredient&rdquo;. That&rsquo;s a little long so maybe put the legend on top instead of
    ...
    <p><span>You were limited to just </span><span>a 6-month supply.</span></p>
    ...
    <p><span>You&rsquo;re going to pay just </span><span>$16.42</span><span>&nbsp;per bottle for a six month supply of
        Total Brain Boost.</span></p>

    <p><span>That&rsquo;s a </span><span>45%</span><span>&nbsp;discount.</span></p>

    <p><span>And a </span><span>$162.70</span><span>&nbsp;total
        savings.</span></p>

    <p><span>And if you get the 12 month supply you&rsquo;ll pay just </span><span>$14.46</span><span>&nbsp;per
        bottle&hellip; </span></p>

    <p><span>That&rsquo;s </span><span>52%</span><span>&nbsp;off and a
      </span><span>$372.40</span><span>&nbsp;total savings.</span></p>
    ...
    <p><span>And make sure you take Total Brain Boost for the recommended </span><span>6 or 12
