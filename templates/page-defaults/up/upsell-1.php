...
<body class="c8 wsl">
  ...
  <div class="container mx-auto my-2 p-2 mt-6 mb-11 content-center">

    <div class="flex flex-col items-center justify-center">
    
    <p class="text-center text-red-600 font-bold text-6xl md:text-4xl mt-8">Don&rsquo;t Leave This Page Just Yet!</p>
    
    <h2 class="text-center text-xl md:text-2xl mb-15">Here&rsquo;s An Easy Way To <span class="font-bold">Boost&nbsp;Your&nbsp;Memory, Focus</span> And Mental <span class="font-bold">Energy</span> &nbsp;Even Further&hellip;</span>
    </h2>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">I Also Want To Share An <span class="font-bold">Easy</span>&nbsp;Way To Save An <span class="font-bold">Additional </span><span class="hi li-hi text-red-600">52%</span>&nbsp;On Total Brain Boost&nbsp;Today&hellip;</span>
    </h2>

    <p><span class="hi text-red-600">This is something that will <span class="underline">only</span>&nbsp;be shared on this page.</span></p>
    ...
    <p><span>You&rsquo;ll get an email confirmation that looks like this, confirming your order has been placed&hellip;</span></p>
    ...
    <p><span>This means you&rsquo;re literally just days away from having Total Brain Boost in your
      ...
      <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">And That Means You&rsquo;re Days Away From Starting To <span class="font-bold">&nbsp;Think Sharper </span>With A <span class="font-bold">Stronger Memory</span>&nbsp;- And Feeling <span class="font-bold">Better </span>And<span class="font-bold">&nbsp;More Confident </span> In Everything You Do&hellip;</span>
      </h2>
    ...
    <div class="my-5">
      <ul class=" lst-kix_3ydq7y3f71fk-0 start">
        <li class="  li-bullet-0"><span>Boosting your </span><span class="font-bold">brain health</span><span>&hellip;</span></li>
      </ul>
      ...
      <ul class=" lst-kix_3ydq7y3f71fk-0">
        <li class="  li-bullet-0"><span>Sharpen your thinking and </span><span class="font-bold">focus</span><span>&hellip;</span></li>
      </ul>

      <ul class=" lst-kix_3ydq7y3f71fk-0">
        <li class="  li-bullet-0"><span>And increase </span><span class="font-bold">mental energy</span><span>&nbsp;and boost your </span><span class="font-bold">mood</span><span>. </span></li>
      </ul>
    </div>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-2">You&rsquo;ll Feel So <span class="font-bold">Good</span><span>&nbsp;</span></h2> 
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">You&rsquo;ll Want To Stay Like This <span class="font-bold">Forever</span></h2>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">And You Want To Keep Taking Total Brain Boost&nbsp;Daily To Help Your Mind Stay Sharp, Focused, Energetic, And Healthy&hellip; For Years To&nbsp;Come
    </h2>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">Will Give You The <span class="font-bold">Longest-Lasting&nbsp;Results</span></h2>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">Get An Additional 6 or 12 Month Supply of Total Brain Boost At A 
    ...
    <p><span class="hi li-hi">You&rsquo;re going to pay just <span class="text-red-600 font-semibold">$16.42</span>&nbsp;per bottle for a six month supply of
        Total Brain Boost.</span></p>

    <p><span class="hi li-hi">That&rsquo;s a <span class="text-red-600 font-semibold">45%</span>&nbsp;discount.</span></p>

    <p><span class="hi li-hi">And a <span class="text-red-600 font-semibold">$162.70</span>&nbsp;total
        savings.</span></p>

    <p><span class="hi li-hi">And if you get the 12 month supply you&rsquo;ll pay just <span class="text-red-600 font-semibold">$14.46</span>&nbsp;per bottle&hellip; </span></p>

    <p><span class="hi li-hi">That&rsquo;s <span class="text-red-600 font-semibold">52%</span>&nbsp;off and a <span class="text-red-600 font-semibold">$372.40</span>&nbsp;total savings.</span></p>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">There&rsquo;s Just<span class="font-bold">&nbsp;One&nbsp;Catch</span>&hellip;</h2>
    ...
    <h2 class="text-center font-semibold text-xl md:text-3xl mb-4">This Deal Will Be<span class=" font-bold">&nbsp;Gone For Good</span></h2>
    ...
    <div class="flex justify-center">
      <img class="w-full mx-auto mb-4" alt="product page" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/upsell1/product-page.webp" title="" loading="lazy">
    </div>
 ...
 <div id="second-qualify-wrap" class="w-full">
    ...
    <div class="w-full">
		  <div class="flex flex-col justify-center items-center border border-4 fs-green p-4 md:py-5 mb-5">
			  <div class="w-full">
          <h2 id="second-cta" class="flex justify-center font-bold text-center text-blue text-3xl md:text-5xl uppercase mb-0">Congratulations!</h2>
          <p class="flex justify-center text-center mb-6 text-tygreen text-base md:text-2xl">You Qualify For This Exclusive Discount of Total Brain Boost</p>
        <div class="gap-4 columns-1 md:columns-2">
          <div class="flex flex-col text-center justify-center mb-6 md:mb-0">
            <p></p>
