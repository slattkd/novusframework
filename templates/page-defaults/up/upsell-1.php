...
<body class="c8 wsl">
  ...
  <div class="container-sm mx-auto my-2 p-2 mt-6 mb-11 content-center">
    ...
    <div class="flex flex-col items-center justify-center">
      ...
      <h1 class="text-center text-red-600 font-bold text-6xl md:text-4xl md:mt-8" style="font-weight: bold">Don&rsquo;t Leave This Page Just&nbsp;Yet!</h1>
      ...
      <div>
        ...
        <p id="scroll-to-cta"><span>All you need to do now is </span><span class="font-bold">click the button below to see if you
            ...
            <div class="gap-4 columns-1 md:columns-2">
              ...
              <div class="flex flex-col text-center justify-center">
                ...
                <p class="title font-semibold text-lg md:text-2xl">Get a <?= $product2['product_month']; ?>-month supply
                  <br> for just $<?= $product2['product_price']; ?> Today!</p>
    ...
    <div class="flex flex-col items-center justify-center w-full md:w-3/4 mx-auto mt-11">
      ...
      <div class="text-sm text-center mb-4 w-4/5">Please remember that once you leave this page, this deal is gone for good, you cannot call or email to get this deal again.</div>
