...
<style type="text/css">
  ...
  .wsl li {
    list-style: none;
    padding: 10px 30px;
    background-image: url('//<?= $_SERVER["HTTP_HOST"];?>///<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/check-green.png');
  ...
  .wsl li.red-x {
    background-image: url('//<?= $_SERVER["HTTP_HOST"];?>///<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/red-x.png');
  }
...
<body class="bg-gray-100 wsl">
  ...
  <h1 class="text-3xl md:text-5xl text-tygreen leading-6 title" id="h.gjdgxs"><span>This Florida MD&rsquo;s 20-Second </span><span
      class=" font-bold">&ldquo;Cerebral Boost&rdquo;</span><span class="   ">&nbsp;Strengthens Your Memory And
      Focus, Keeping You Razor Sharp Well Into Your 50s, 60s, 70s, and even 80s&hellip; </span></h1>
  

  <h3 class="text-center text-lg md:text-2xl mb-4 md:mb-8" id="h.30j0zll"><span>While Helping To Fight Off Memory Loss, Brain Fog, And Cognitive Decline
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image37.png"
        style="width: 624.00px; height: 306.67px; " class="md:ml-4 mb-3 w-full mx-auto" title="">
</picture>
...
<img  alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image16.png"
        style="width: 256.50px; height: 159.49px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>

  <p><span>Hi, I&rsquo;m </span><span class="font-bold">Dr. Steven Masley</span><span class="font-bold">, </span><span
      class="  font-bold">MD, FAHA, FACN, CNS</span><span class="font-bold">&nbsp;</span></p><sup><a href="#cmnt5"
      id="cmnt_ref5">[e]</a></sup>
...
<div style="clear:both"></div>
  ...
  <p><span>This </span><span class="font-bold">simple</span><span>&nbsp;method works by activating a </span><span
      class="font-bold">very</span><span>&nbsp;</span><span class="font-bold">specific</span><span>&nbsp;part of the brain that has
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1fob9te"><span>And The Best Part Is, This </span><span>&ldquo;Cerebral Boost&rdquo; Method
    </span><span>Is Completely Natural And Starts Working Almost Instantly&hellip; </span></h2>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.3znysh7"><span>Imagine your mind </span><span class="font-bold">buzzing</span><span>&nbsp;with newfound
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image5.png"
        style="width: 275.16px; height: 278.68px; "
  ...
  <p><span>And more like you want to go out and live your </span><span class="font-bold">life to the fullest.</span></p>
  <div style="clear:both"></div>
</div>

  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2et92p0"><span>Imagine thinking </span><span class="font-bold">clearer</span><span>&nbsp;and being more
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.tyjcwt"><span>I&rsquo;ve Been Able To Help </span><span
      class="font-bold">Thousands</span><span>&nbsp;Of Men And Women Strengthen Their Memory, Feel More </span><span
      class="font-bold">Focused</span><span>, Think </span><span class="font-bold">Faster</span><span>, And Feel Ready To Take On The
      World&hellip; </span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 336.00px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image35.png"
        style="width: 624.00px; height: 336.00px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></h2><sup><a href="#cmnt7" id="cmnt_ref7">[g]</a></sup>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.3dy6vkm"><span>But no matter what she tried, Grace just couldn&rsquo;t fend off the </span><span
      class="font-bold">chronic exhaustion, memory lapses,</span><span>&nbsp;and </span><span class="font-bold">brain fog</span><span
      class=" ">&nbsp;she felt all day long&hellip; </span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 296.93px; height: 236.50px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image10.png"
        style="width: 296.93px; height: 236.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>Worse, her friends had started to avoid her&hellip; </span></p><sup><a href="#cmnt8"
      id="cmnt_ref8">[h]</a></sup>
  ...
  <p><span>With her new found focus she was even able to be more active socially&hellip;</span>
  </p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.xw2vwr9mkn4s"><span>When another woman, named </span><span
      class="font-bold">Sally,</span><span>&nbsp;came to see me, she was afraid of</span><span class="font-bold">&nbsp;losing her
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.1t3h5sf"><span>She </span><span class="font-bold">couldn&rsquo;t think straight</span><span>&nbsp;and
      could barely keep her eyes open after lunch, </span><span class="font-bold">no matter how much she slept</span><span
      class=" ">&nbsp;the night before&hellip; </span></h3>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image15.png"
        style="width: 624.00px; height: 341.33px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt9" id="cmnt_ref9">[i]</a></sup></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.m3fbvzvv5tq"><span>Then there&rsquo;s Dale&hellip;</span></h3><sup><a href="#cmnt10"
      id="cmnt_ref10">[j]</a></sup>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 284.50px; height: 254.13px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image2.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image2.png"
        style="width: 284.50px; height: 254.13px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>He had been a </span><span>highly-successful CEO for a local company</span><span
      >&nbsp;for nearly 10 years. </span></p>
  ...
  <h2 ><span>And when he came back, he told me he felt like he&rsquo;d </span><span class="font-bold">turned back
      the clock 20 years</span><span class=" ">... </span></h2>
  ...
  <p><span>And felt like he was back on top of the world</span><span>.</span><sup><a href="#cmnt11"
        id="cmnt_ref11">[k]</a></sup></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.2s8eyo1"><span>Now, I Want To Show You How You Can </span><span
      class="font-bold">Boost</span><span>&nbsp;Your Memory And Sharpen Your Mind Too, Using This </span><span
      class="font-bold">&ldquo;Cerebral Boost&rdquo;</span><span class=" ">&nbsp;Method I Mentioned Earlier&hellip;
    </span></h2>
  ...
  <p><span>The research I and others have </span><span>done that shows</span><span
      class=" ">&nbsp;just how powerful it is&hellip; </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  ><span>I&rsquo;ll also give you my top</span><span class=" font-bold">&nbsp;Brain-Boosting
      afternoon snack recipe... </span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 157.50px; height: 147.17px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image38.png"
        style="width: 157.50px; height: 147.17px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></h3><sup><a href="#cmnt12" id="cmnt_ref12">[l]</a></sup>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.17dp8vu"><span class=" ">I&#39;ve Helped Hundreds of Men &amp; Women Boost Their Memory,
      Focus, And Cognition Speed At My Clinic In St. Petersburg, FL&hellip;</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 288.50px; height: 236.26px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image39.png"
        style="width: 288.50px; height: 236.26px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>Now, as I said before, my name is</span><span class="font-bold">&nbsp;Dr. Steven
      Masley</span><span>&hellip; &nbsp;</span></p><sup><a href="#cmnt13" id="cmnt_ref13">[m]</a></sup>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3rdcrjn"><span class="font-bold">Something Terrible Happened</span><span class=" ">&nbsp;That
      Changed The Course Of My Life And My Career Forever&hellip; </span></h2>
  

  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 260.00px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image12.png"
        style="width: 624.00px; height: 260.00px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt14" id="cmnt_ref14">[n]</a></sup></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.26in1rg"><span>Chuck Now Just Sat In A Recliner Like A Vegetable, </span><span
      class="font-bold">Suffering</span><span>&hellip; In </span><span class="font-bold">Misery</span><span
      class=" ">&hellip;</span></h2>
  ...
  <p><span>There was </span><span class="font-bold">nothing</span><span>&nbsp;I knew of to fix
      this.</span></p>
  <h2 ><span>Modern, traditional medicine provided </span><span class="font-bold">no solution</span><span
      class=" ">&nbsp;to Chuck&rsquo;s ailments...</span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 258.50px; height: 167.78px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image31.png"
        style="width: 258.50px; height: 167.78px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></h2>
...
<sup><a href="#cmnt15" id="cmnt_ref15">[o]</a></sup>
  ...
  <h2 ><span>And when I arrived, he miraculously sat up in bed, &nbsp;took my hand, looked me in the eyes and
      said </span><span class="  text-blue font-bold">&quot;Please, don&#39;t let this happen to others!&quot; </span></h2>
  ...
  <h2 ><span>I Quickly Realized How Many Things Were </span><span class="font-bold">Wrong</span><span
      class=" ">&nbsp;With The Medical Industry&hellip; </span></h2>
  ...
  <p><span>And you find out what&#39;s </span><span class="font-bold">REALLY causing</span><span
      >&nbsp;their memory loss, or lack of focus, or low libido &hellip;or whatever their specific problem
      is.</span></p>
  

  <p><span>And you address what&#39;s causing it.</span></p>
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.35nkun2"><span>This Led To A </span><span class="font-bold">Shocking Discovery</span><span
      class=" ">&nbsp;About What Really Causes Mental Fatigue, Brain Fog, And Memory Loss As You Age&hellip;
    </span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 405.33px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image21.png"
        style="width: 624.00px; height: 405.33px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt16" id="cmnt_ref16">[p]</a></sup></p>
  ...
  <h2 ><span>One of the </span><span class="font-bold">most</span><span>&nbsp;</span><span
      class="font-bold">overlooked</span><span>&nbsp;causes of memory loss and lack of focus&hellip; &nbsp;is in an area of the
  ...
  <p><span>The </span><span class="font-bold">forebrain</span><span>&nbsp;makes </span><span
      class="font-bold">learning</span><span>&nbsp;and </span><span class="font-bold">memory</span><span
      >&nbsp;possible.</span></p>
  ...
  <p><span>Your forebrain essentially controls </span><span class="font-bold">how you live and think</span><span
      >&hellip;</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.1ksv4uv"><span>When the </span><span class="font-bold">&ldquo;forebrain&rdquo; slows down</span><span
      class=" ">, so do many critical functions in the body along with it&hellip; &nbsp;</span></h3>
  
  <p><span class=" ">And you will feel: </span></p>
  

  <ul class="p-3 lst-kix_list_7-0 start">
    <li class="   li-bullet-0"><span>More sluggish </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_7-0">
    <li class="   li-bullet-0"><span>Less focused</span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_7-0">
    <li class="   li-bullet-0"><span>Less alert</span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_7-0">
    <li class="   li-bullet-0"><span>Remember less</span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_7-0">
    <li class="   li-bullet-0"><span>Have less self-control.</span></li>
  </ul>
  

  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.44sinio"><span>This Decrease In Brain Processing Speed Is Something I Call </span><span
      class="font-bold">&ldquo;Synaptic Slowdown&rdquo;</span><span class=" ">... </span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 277.50px; height: 240.76px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image33.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image33.png"
        style="width: 277.50px; height: 240.76px; margin-left: -0.00px; margin-top: -0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>The term</span><span class="font-bold">&nbsp;&ldquo;synaptic slowdown&rdquo;</span><span>&nbsp;comes from
      the term &ldquo;synapses&rdquo;...</span></p><sup><a href="#cmnt17" id="cmnt_ref17">[q]</a></sup>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2jxsxqh"><span>I&rsquo;ve found that &ldquo;Synaptic Slowdown&rdquo; is usually </span><span
      class="font-bold">caused by two </span><span class="font-bold">things&hellip;</span><span class="   font-bold">&nbsp; </span>
  </h3>
  

  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 310.67px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image7.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image7.png"
        style="width: 624.00px; height: 310.67px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt18" id="cmnt_ref18">[r]</a></sup></p>
  ...
  <p><span>The brain relies on nutrients from the food we eat</span><span class="font-bold">&nbsp;</span><span
      >to process information quickly.</span></p>
  

  <p><span>But over the last 70 years&hellip;</span></p>
  

  <p><span>Our food has become significantly </span><span class="font-bold">less nutritious</span><span
      >.</span></p>
  

  <p><span>Because of </span><span class=" font-bold">soil degradation</span><span
      class=" ">&nbsp;from modern farming&hellip; </span></p>
  
  <p><span>Many fruits, vegetables, and </span><span>grains grown</span><span
      class=" ">&nbsp;today&hellip; </span></p>
  
  <p><span>Have up to </span><span class=" font-bold">38% less</span><span
      class=" ">&nbsp;vitamins and minerals&hellip; &nbsp;</span></p>
  ...
  <p><span>And these toxins</span><span class=" font-bold">&nbsp;cause havoc</span><span
      >&nbsp;with our brain&hellip;</span></p>
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.z337ya"><span>Leading brain cells to </span><span class=" font-bold">lose function </span><span
      class="font-bold">and</span><span class=" font-bold">&nbsp;die.</span><span class="   ">&nbsp;</span></h3>
  
  <p><span>And when you combine the </span><span class=" font-bold">damage</span><span
      class=" ">&nbsp;from these toxins and nutrient deficiencies&hellip; &nbsp;</span></p>
  
  <p><span>Along with </span><span>a natural drop from </span><span
      class="font-bold">aging</span><span>&nbsp;and unmanaged </span><span class="font-bold">stress</span><span>&nbsp;in
      your life&hellip;</span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 229.50px; height: 202.79px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image34.png"
        style="width: 229.50px; height: 202.79px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  ...
  <p><span>It literally </span><span class="font-bold">shrinks</span><span>&nbsp;as can be seen with MRI
      scanning&hellip;</span></p><sup><a href="#cmnt19" id="cmnt_ref19">[s]</a></sup>
  ...
  <p><span>The</span><span class="font-bold">&nbsp;good news </span><span>is there is something you can do about
      it&hellip; </span></p>
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3j2qqm3"><span>The </span><span class="font-bold">Breakthrough</span><span>&nbsp;Brain-Boosting
      Discovery Many Doctors Thought Was </span><span class="font-bold">&ldquo;Impossible&rdquo;</span><span
      class=" ">&hellip; </span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 418.67px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image27.png"
        style="width: 624.00px; height: 418.67px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt20" id="cmnt_ref20">[t]</a></sup></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1y810tw"><span class=" ">That&rsquo;s Why I Took Matters Into My Own Hands&hellip;</span>
  </h2>
  
  <p><span>In 2008&hellip; I conducted my own 10-week randomized clinical study</span><sup
      class=" "><a href="#ftnt3" id="ftnt_ref3">[3]</a></sup><span>&nbsp;at my clinic, </span><span
      class=" font-bold">The Masley Optimal Health Center</span><span class=" ">&hellip; </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.4i7ojhp"><span>Participants were able to </span><span class="font-bold">boost</span><span>&nbsp;their
      brain speed by an amazing </span><span class="font-bold">average of 24.6%</span><span class=" ">...</span></h3>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2xcytpi"><span>And in many cases they saw some of these </span><span
      class="font-bold">benefits</span><span>&nbsp;within the </span><span class="font-bold">first few days</span><span
      class=" ">&nbsp;of starting my program..</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 295.50px; height: 216.42px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image28.png"
        style="width: 295.50px; height: 216.42px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt21" id="cmnt_ref21">[u]</a></sup>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1ci93xb"><span>Over The Years I&rsquo;ve Identified </span><span class="font-bold">6
      Nutrients</span><span class=" ">&nbsp;I Believe Boost The Brain The Best</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 280.00px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image13.png"
        style="width: 624.00px; height: 280.00px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span><sup><a href="#cmnt22" id="cmnt_ref22">[v]</a></sup></p>
  

  <p><span>I call the daily preparation and taking of these essential nutrients a critical part of my
    </span><span class="font-bold">&ldquo;</span><span class=" font-bold">Cerebral Boost</span><span class="font-bold">&rdquo;</span><span
      >&nbsp;Method.</span></p>
  

  <p><span>And I&rsquo;ve seen that it cannot only help </span><span class="font-bold">boost</span><span>&nbsp;your
      memory, mental </span><span class="font-bold">energy</span><span>, </span><span class="font-bold">focus</span><span>, and
  ...
  <p><span>All of which can help you live a </span><span class="font-bold">happier</span><span>, </span><span
      class="font-bold">longer</span><span>, and more </span><span class="font-bold">fulfilling</span><span>&nbsp;life.
    </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.3whwml4"><span>This often leads them to become </span><span class="font-bold">more active</span><span>,
  ...
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 249.32px; height: 228.55px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image17.png"
        style="width: 249.32px; height: 228.55px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt23" id="cmnt_ref23">[w]</a></sup>
  ...
  <p><span>And I can say that I&rsquo;ve seen the results </span><span class="font-bold">first-hand</span><span
      >.</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2bn6wsx"><span>I can honestly say that today, at 67 years old, I feel </span><span
      class="   font-bold">great</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 260.52px; height: 249.29px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image11.png"
        style="width: 260.52px; height: 249.29px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt24" id="cmnt_ref24">[x]</a></sup>
  ...
  <p><span>As I said before, there are</span><span class="font-bold">&nbsp;6 nutrients </span><span>that I found to
      be the </span><span class="font-bold">best</span><span>&nbsp;at </span><span class="font-bold">boosting the brain</span><span
      >.</span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.qsh70q"><span class=" ">Brain-Boosting Nutrient #1: Curcumin</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 261.50px; height: 176.01px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image8.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image8.png"
        style="width: 261.50px; height: 176.01px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span class="font-bold">Curcumin</span><span>&nbsp;is at the top of my list of brain nutrients because it helps
      ...
      class="font-bold">oxidation</span><span>&nbsp;in the brain. </span></p><sup><a href="#cmnt25"
      id="cmnt_ref25">[y]</a></sup>
  ...
  <p><span>In one study</span><sup ><a href="#ftnt5" id="ftnt_ref5">[5]</a></sup><span>&hellip;
      &nbsp;participants saw</span><span class="font-bold">&nbsp;</span><span class="font-bold ">&ldquo;significantly improved
  ...
  <p><span>Curcumin can also increase growth factors that </span><span class="font-bold">help grow brain
      cells</span><span>.</span><sup ><a href="#ftnt6" id="ftnt_ref6">[6]</a></sup><sup ><a
        href="#ftnt7" id="ftnt_ref7">[7]</a></sup></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.3as4poj"><span>One study suggests </span><span class="font-bold">up to 90 times
      better</span><span>&nbsp;absorption than another.</span><sup ><a href="#ftnt8"
        id="ftnt_ref8">[8]</a></sup><sup ><a href="#ftnt9" id="ftnt_ref9">[9]</a></sup></h3>
  

  <p><span>I&rsquo;ll tell you where to get this new version in just a second. </span></p>
  

  <p><span>But first&hellip; &nbsp;let me tell you about the second smart nutrient... </span></p>
  

  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1pxezwc"><span class=" ">Brain-Boosting Nutrient #2: Resveratrol</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 288.50px; height: 194.18px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image9.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image9.png"
        style="width: 288.50px; height: 194.18px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span class="font-bold">Resveratrol</span><span>&nbsp;is a compound that is naturally found in red </span><span
      class="font-bold">grapes</span><span>&nbsp;and </span><span class="font-bold">blueberries</span><span>.</span><sup><a
        href="#cmnt26" id="cmnt_ref26">[z]</a></sup></p>
  

  <p><span>And has been shown to help </span><span class="font-bold">increase blood flow</span><span>&nbsp;to the
      brain</span><sup ><a href="#ftnt10" id="ftnt_ref10">[10]</a></sup><span>... </span></p>
  

  <p><span>Lower inflammation</span><sup ><a href="#ftnt11" id="ftnt_ref11">[11]</a></sup><span
      >&hellip; </span></p>
  

  <p><span>And help reduce blood sugar levels</span><sup ><a href="#ftnt12"
        id="ftnt_ref12">[12]</a></sup><sup ><a href="#ftnt13" id="ftnt_ref13">[13]</a></sup><sup
      ><a href="#ftnt14" id="ftnt_ref14">[14]</a></sup><span>. </span></p>
  

  <p><span>Several studies</span><sup ><a href="#ftnt15" id="ftnt_ref15">[15]</a></sup><sup
      ><a href="#ftnt16" id="ftnt_ref16">[16]</a></sup><span>&nbsp;have found that taking Resveratrol is
      linked to </span><span class="font-bold">significant improvement</span><span>&nbsp;in cognitive scores in
      postmenopausal women. </span></p>
  

  <p><span>They showed both </span><span class="font-bold">faster</span><span>&nbsp;and </span><span class="font-bold">more
      accurate</span><span>&nbsp;brain processing speed and </span><span class="font-bold">better memory</span><span
      >&nbsp;scores, too.</span></p>
  

  <p><span>And as a bonus, new pilot study</span><sup ><a href="#ftnt17"
        id="ftnt_ref17">[17]</a></sup><span>&nbsp;research on overweight men and women shows that Resveratrol
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.49x2ik5"><span>Brain-Boosting Nutrient #3: Magnesium</span></h2>
  

  <p><span>Magnesium is </span><span class="font-bold">essential</span><span>&nbsp;for messaging to occur between
      brain cells&hellip; </span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 200.64px; height: 213.50px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image32.png"
        style="width: 200.64px; height: 213.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p><sup><a href="#cmnt27" id="cmnt_ref27">[aa]</a></sup>
  ...
  <p><span>Unfortunately, according to research by the National Institutes of Health</span><sup
      ><a href="#ftnt18" id="ftnt_ref18">[18]</a></sup><span class="  font-bold">68% of Americans are low in
      magnesium. </span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.2p2csry"><span>Brain-Boosting Nutrient #4: Vitamin B12</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 266.50px; height: 196.27px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image4.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image4.png"
        style="width: 266.50px; height: 196.27px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  ...
  <p><span>But you might not know that it </span><span class=" font-bold">helps brain cells produce
      energy</span><sup class=" "><a href="#ftnt19" id="ftnt_ref19">[19]</a></sup><span>.</span><span
      >&nbsp;</span></p>
  

  <p><span>And studies link lower B12 levels to a decline in both learning ability and memory </span><sup
      ><a href="#ftnt20" id="ftnt_ref20">[20]</a></sup><sup ><a href="#ftnt21"
        id="ftnt_ref21">[21]</a></sup><span>... </span></p>
  

  <p><span>Another study</span><sup ><a href="#ftnt22" id="ftnt_ref22">[22]</a></sup><span
      >&nbsp;showed B12 dramatically reduced brain shrinkage in the area of the brain most affected by memory
      loss.</span></p>
  ...
  <p><span>This is why this is perhaps the</span><span class="font-bold">&nbsp;single most important </span><span
      >nutrient deficiency that you should avoid.</span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.147n2zr"><span>Brain-Boosting Nutrient #5: Folate</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 234.50px; height: 192.41px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image24.png"
        style="width: 234.50px; height: 192.41px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span class="font-bold">Folate</span><span>&nbsp;helps repair our DNA and remove toxins, which is essential for
      us to stay healthy.</span></p><sup><a href="#cmnt29" id="cmnt_ref29">[ac]</a></sup>
  

  <p><span>People with folate deficiency are at </span><span class="font-bold">elevated risk </span><span
      >for heart problems, depression, and difficulties with concentration and memory. </span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3o7alnk"><span>Brain-Boosting Nutrient #6: Vitamin D</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 209.50px; height: 186.67px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image22.png"
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.23ckvvd"><span>After prescribing many of these nutrients to my patients for years, I found that
      it was </span><span class="font-bold">difficult to find the quality</span><span class=" ">&nbsp;that I was looking
      for&hellip; </span></h3>
  ...
  <h2 class="  " id="h.ihv636"><span class="font-bold">Total Brain Boost&reg;</span><span class=" ">: A Powerful
      Formula Using 6 of the Best, Scientifically-Backed, Brain-Boosting Nutrients I&rsquo;ve Found Over 30 Years of
      Research&hellip; &hellip;</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 197.12px; height: 331.50px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image19.png"
        style="width: 197.12px; height: 331.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span class="font-bold">Total Brain Boost</span><span>&nbsp;is the only health supplement that contains all 6
      of these top brain-enhancing nutrients I discovered in my last 30 years of research&hellip; </span></p><sup><a
      href="#cmnt31" id="cmnt_ref31">[ae]</a></sup>
  ...
  <p><span>And have been shown to </span><span class="font-bold">safely</span><span>&nbsp;and </span><span
      class="font-bold">effectively</span><span>&nbsp;help people </span><span class="font-bold">boost brain health</span><span
      >&nbsp;at almost any age. </span></p>
  ...
  <p><span>And you&rsquo;re not only getting </span><span class="font-bold">more things done</span><span
      >&hellip; </span></p>
  

  <p><span>You&rsquo;re getting them done </span><span class="font-bold">faster</span><span>... </span>
  </p>
  ...
  <p><span>And when you feel better like this, it&rsquo;s easier to make better eating choices
      too.</span></p>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 294.50px; height: 237.87px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image3.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image3.png"
        style="width: 294.50px; height: 237.87px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>Imagine focusing, listening, and socializing better with your family and friends&hellip; </span>
  </p><sup><a href="#cmnt32" id="cmnt_ref32">[af]</a></sup>
  

  <p><span>Perhaps everyone will be pleasantly </span><span class="font-bold">surprised</span><span
      >&nbsp;by how sharp and &lsquo;on the ball&rsquo; you are.. </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.32hioqz"><span class=" ">And I believe this could help you too.</span></h3>
  ...
  <p><span>They would cost you about</span><span class="font-bold">&nbsp;$100 per month</span><span
      >&nbsp;if you bought them from a trusted brand&hellip; </span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1hmsyys"><span class=" ">With Total Brain Boost You Won&rsquo;t Have To Pay Anywhere Near
  ...
  <p><span>Today you&rsquo;re going to get Total Brain Boost for</span><span
      class=" font-bold">&nbsp;just $69.95</span><span>&nbsp;for a 30-day supply. </span></p>
  

  <p><span>That&rsquo;s </span><span class=" font-bold">28% </span><span class="font-bold">OFF</span><span
      >&nbsp;the estimated retail brand&rsquo;s cost</span><span>&hellip;</span></p>
  ...
  <p><span>And that&rsquo;s just</span><span class=" font-bold">&nbsp;$69.95
      period</span><span>&mdash;</span><span>combined in one </span><span>easy-to-take</span><span
      >&nbsp;pill.</span></p>
  

  <p><span class="font-bold">No hidden fees or billings.</span></p>
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.41mghml"><span class=" ">All you need to claim this discount is to click the button
      below... </span></h3>
  

  <p class=" title" id="h.2grqrue"><span class=" ">[Insert: CART BUTTON]</span></p>
  

  <h2 ><span>Ordering Is </span><span class="font-bold">Easy</span><span class=" ">&hellip;</span></h2>
  

  <p><span>You don&rsquo;t need a prescription.</span></p>
  

  <p><span>You only need to want to transform your life for the </span><span class="font-bold">better</span><span
      >.</span></p>
  

  <p><span>And if you want to save even more&hellip; &nbsp;</span></p>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 269.50px; height: 199.10px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image40.png"
        style="width: 269.50px; height: 199.10px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  ...
  <p><span>Also, most of the scientific studies I showed you earlier were done over 2 to 3 months
      or longer</span></p>
  <p>&nbsp;</p>
  <p><span>So I recommend taking Total Brain Boost for </span><span class="font-bold">3 months or longer</span><span
      >&nbsp;to get the best results&hellip; </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.vx1227"><span class="  text-blue  font-bold">So click here to secure your discount package now.
    </span></h3>
  

  <p><span>And when you do&hellip; </span></p>
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3fwokq0"><span>You&rsquo;ll Also Get A </span><span class="font-bold">90-Day Money Back Guarantee
    </span><span class=" ">With Your Order Today&hellip;</span></h2>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 152.50px; height: 152.50px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image29.png"
        style="width: 152.50px; height: 152.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt34" id="cmnt_ref34">[ah]</a></sup>
  ...
  <p><span>All you need to do is call or email within 90 days and say, &ldquo;I want to use my
      money-back guarantee.&rdquo; </span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 210.50px; height: 183.51px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image18.png"
        style="width: 210.50px; height: 183.51px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  

  <p><span>And that&rsquo;s it - you&rsquo;ll get your </span><span class="font-bold">money back in full</span><span
      >&hellip;</span></p>
...
<sup><a href="#cmnt35" id="cmnt_ref35">[ai]</a></sup>
  ...
  <p><span class="font-bold">No questions</span><span>&nbsp;</span><span class="font-bold">asked</span><span>&nbsp;and
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.1v1yuxt"><span class=" ">All you need to do to claim your discount and your 90-day money
      back guarantee is click the button below&hellip; </span></h3>
  

  <p><span class=" ">&nbsp;</span><span class=" ">[Insert: CART BUTTON]</span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.4f1mdlm"><span>You Get </span><span class="font-bold">5 Free Bonus Gifts</span><span>&nbsp;Filled With
      Tips To Further Boost Your Results&hellip; &nbsp;</span></h2>
  

  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.477wsv67uk7z"><span class="font-bold">Bonus Gift #1:</span><span class=" ">&nbsp;The Total Brain
      Booster Guide. </span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 237.75px; height: 220.60px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image36.png"
        style="width: 237.75px; height: 220.60px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>This digital guide shows you exactly how to get the most out of Total Brain Boost,
      including:</span></p><sup><a href="#cmnt36" id="cmnt_ref36">[aj]</a></sup>
  

  <ul class="p-3 lst-kix_list_2-0 start">
    <li class="  li-bullet-0"><span>When to take it&hellip; </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_2-0">
    <li class="  li-bullet-0"><span>What to take it with to increase its power and the speed of your
        results&hellip; &nbsp;</span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_2-0">
    <li class="  li-bullet-0"><span>Including 3 delicious foods that can increase the effectiveness of
        Total Brain Boost&hellip; </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_2-0">
    <li class="  li-bullet-0"><span>Plus, how to follow the ideal 3-6 month regimen for best
        results&hellip;</span></li>
  </ul>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.19 font-bold y18"><span class="font-bold">Bonus Gift #2:</span><span class=" ">&nbsp;The Better Brain
      Cookbook</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 211.77px; height: 196.50px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image14.png"
        style="width: 211.77px; height: 196.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt37" id="cmnt_ref37">[ak]</a></sup>
  ...
  <ul class="p-3 lst-kix_list_8-0 start">
    <li class="  li-bullet-0"><span>These foods help boost your brain so you feel more focused, alert,
        and energized&hellip; </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_8-0">
    <li class="  li-bullet-0"><span>You&rsquo;ll get 14 delicious and easy recipes for meals and snacks
        to fuel your day&hellip; </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_8-0">
    <li class="  li-bullet-0"><span>You&rsquo;ll also get my &ldquo;brain-boosting snack&rdquo; recipe,
        the one I mentioned earlier. The recipe for this is so simple&mdash;I&rsquo;ll share it with you right now:
        &nbsp;In a bowl, combine blueberries, low-fat, organic plain yogurt (no sweetener or sugar added), with sliced
        almonds, and a dash of cinnamon. It&rsquo;s easy and delicious. The probiotics in the yogurt and the nutrients
        in the blueberries enhance brain function&hellip; </span></li>
  </ul>
  
  <ul class="p-3 lst-kix_list_8-0">
    <li class="  li-bullet-0"><span>And the instant &ldquo;brain-boosting&rdquo; shake you can make for
        fast focus and energy whenever you&rsquo;re feeling tired and don&rsquo;t want to drink a coffee&hellip; </span>
    </li>
  </ul>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.3tbugp1"><span class="font-bold">Bonus Gift #3:</span><span class=" ">&nbsp;Brain Draining Foods
      to Avoid</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 190.50px; height: 177.88px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image30.png"
        style="width: 190.50px; height: 177.88px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt38" id="cmnt_ref38">[al]</a></sup>
  ...
  <ul class="p-3 lst-kix_list_9-0 start">
    <li class="  li-bullet-0"><span>The #1 food you&rsquo;ll want to avoid at all costs when grocery
        shopping&mdash;make sure you look for this on the label and do not buy foods that contain it&hellip; </span>
    </li>
  </ul>
  
  <ul class="p-3 lst-kix_list_9-0">
    <li class="  li-bullet-0"><span>Toxic sweeteners - which sweeteners to avoid that can cause elevated blood
        sugar and headaches, and damage the gut microbiome&hellip; including the two so-called &ldquo;all natural&rdquo;
        sweeteners</span><sup ><a href="#ftnt23" id="ftnt_ref23">[23]</a></sup><span>... </span>
    </li>
    <li class="  li-bullet-0"><span>Which cooking oils to avoid, plus the natural, delicious, and
        healthy alternatives to use instead&hellip; </span></li>
    <li class="  li-bullet-0"><span>The 5 worst sauces you could ever eat that are loaded with
        brain-draining ingredients and the 5 best ones that I recommend instead&hellip; </span></li>
    <li class="  li-bullet-0"><span>Foods that contain the worst and highest levels of toxins you want
        to avoid&hellip; </span></li>
  </ul>
  

  <ul class="p-3 lst-kix_list_9-0">
    <li class="  li-bullet-0"><span>And lastly, I&rsquo;ll also tell you the 3 foods you should never
  ...
  <p><span>Grain cereals are often packed with sugar and wheat, which may cause inflammation in the
      brain&hellip;</span><sup ><a href="#ftnt24" id="ftnt_ref24">[24]</a></sup><span
      >&nbsp;</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.28h4qwu"><span class="font-bold">Bonus Gift #4:</span><span class=" ">&nbsp;Simple Brain-Boosting
      Exercises</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 187.50px; height: 173.38px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image6.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image6.png"
        style="width: 187.50px; height: 173.38px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>Next</span><span>, you&rsquo;ll also get my </span><span>&ldquo;</span><span
      class=" font-bold">Simple Brain-Boosting Exercises</span><span class="font-bold">&rdquo;</span><span
      >&nbsp;digital ebook.&nbsp;</span></p><sup><a href="#cmnt39" id="cmnt_ref39">[am]</a></sup>
  <p><span>The exercises in this book are designed to be short</span><span
      >&hellip;</span></p>
  ...
  <ul class="p-3 lst-kix_list_4-0 start">
    <li class="  li-bullet-0"><span>3 quick, easy, physical exercises to boost your mental
        ...
        show these exercises can improve function in the hippocampus, the part of the brain that&rsquo;s responsible for
        learning and verbal memory</span><span>)</span></li>
  </ul>
  <ul class="p-3 lst-kix_list_6-0 start">
    <li class="  li-bullet-0"><span>T</span><span>he special mid-day walking technique you can do in
    ...
    <li class="  li-bullet-0"><span>T</span><span>he simple &ldquo;milk jug&rdquo; technique that
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.nmf14n"><span class="font-bold">Bonus Gift #5:</span><span class=" ">&nbsp;Simple Stress
      Management</span></h3>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 176.21px; height: 163.50px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image1.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image1.png"
        style="width: 176.21px; height: 163.50px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>And finally, you&rsquo;ll also get my &ldquo;</span><span
      class="font-bold">Simple</span><span>&nbsp;</span><span class="font-bold">Stress Management&rdquo;</span><span>&nbsp;digital
      ebook.&nbsp;</span></p><sup><a href="#cmnt40" id="cmnt_ref40">[an]</a></sup>
  ...
  <ul class="p-3 lst-kix_list_4-0">
    <li class="  li-bullet-0"><span>The simple 1-minute &ldquo;chair meditation&rdquo; you can do
        anywhere to center yourself and clear your mind when things get crazy (it&rsquo;s like an instant
        &ldquo;pick-me-up&rdquo; for mood and concentration)...</span></li>
  </ul>
  <ul class="p-3 lst-kix_list_6-0">
    <li class="  li-bullet-0"><span>An ancient &ldquo;counting breaths&rdquo; technique that lowers
    ...
    <li class="  li-bullet-0"><span>Then try this A.M &ldquo;body scan&rdquo; while lying in bed to
        target and remove areas of tension that are holding you back and weighing down your body and mind. (This helps
        you start your day with more energy, ease and focus.) </span></li>
    <li class="  li-bullet-0"><span>Plus</span><span>&nbsp;the easy &ldquo;Total Calmness&rdquo;
        exercise to calm your mind in as little as 3 minutes &ndash; Stress wreaks havoc on the brain and this simple
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.37m2jsg"><span class="   font-bold">All you need to do is to click the button below:</span>
  </h3>
  

  <p><span class=" ">&nbsp;</span><span class=" ">[CART BUTTON]</span></p>
  <p><span class="  font-bold"></span></p>
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1mrcu09"><span class="font-bold">Total Brain Boost</span><span>&nbsp;Is Formulated With Ingredients You
      Can </span><span class="font-bold">Trust</span><span class=" ">&hellip;</span></h2>
  

  <p><span>I also want to take a second to talk about the </span><span class="font-bold">quality</span><span
      >&nbsp;of the ingredients used in Total Brain Boost.</span></p>
  ...
  <ol class=" lst-kix_list_10-0 start" start="1">
    <li class="  li-bullet-0"><span>It&rsquo;s made in a </span><span class="font-bold">GMP-certified</span><span
        >&nbsp;facility</span></li>
  </ol>
  

  <ol class=" lst-kix_list_10-0" start="2">
    <li class="  li-bullet-0"><span>It&rsquo;s been </span><span class="font-bold">third party tested</span><span
        >&nbsp;by a reputable company</span></li>
  </ol>
  

  <ol class=" lst-kix_list_10-0" start="3">
    <li class="  li-bullet-0"><span>You know </span><span class="font-bold">exactly</span><span>&nbsp;where the
        product is manufactured</span></li>
  </ol>
  
  <ol class=" lst-kix_list_10-0" start="4">
    <li class="  li-bullet-0"><span>You are sure that it contains ingredients that are </span><span
        class="font-bold">safe</span><span>&nbsp;and have been </span><span class="font-bold">proven</span><span>&nbsp;to
        work</span></li>
  </ol>
  ...
  <p><span>It&rsquo;s put through a thorough series of lab tests by a trusted third party lab</span><span>.
    </span><sup><a href="#cmnt41" id="cmnt_ref41">[ao]</a></sup><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 206.50px; height: 152.56px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image26.png"
        style="width: 206.50px; height: 152.56px; "
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  ...
  <p><span>Total Brain Boost is also </span><span class="font-bold">allergen free</span><span>&hellip; </span><span
      class="font-bold">gluten free</span><span>&hellip; and </span><span class="font-bold">lactose free</span><span
      >.</span></p>
  

  <p><span>As I said before...</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.46r0co2"><span>Just </span><span class="font-bold">click the button below</span><span
      class=" ">&nbsp;to continue to the secure order page:</span></h3>
  

  <p><span class=" ">&nbsp;</span><span class=" ">[CART BUTTON]</span></p>
  

  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.2lwamvv"><span class=" ">Here&rsquo;s What Happens Next&hellip;</span></h2>
  ...
  <p><span>The site uses </span><span class="font-bold">256-Bit Secure SSL technology</span><span
      >&hellip; </span></p>
  ...
  <p><span>Your order will be processed the same day&hellip;</span><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 175.50px; height: 108.37px;">
<picture>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image23.png"
        style="width: 175.50px; height: 108.37px; margin-left: -0.00px; margin-top: -0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
...
<sup><a href="#cmnt42" id="cmnt_ref42">[ap]</a></sup>
  ...
  <p><span>If you&rsquo;re overseas, your package will take </span><span class="font-bold">just 6-8 days</span><span
      >&nbsp;on average to arrive.</span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.111kx3o"><span>A Portion Of Your Purchase Will Be Donated To The </span><span
      class="  text-blue font-bold">Vitamin Angels Charity</span></h2>
  <p><span>This charity helps get vitamins to an impoverished child living in a third-world
      country&hellip;</span></p>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 238.71px; height: 162.58px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image41.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image41.png"
        style="width: 238.71px; height: 162.58px; margin-left: -0.00px; margin-top: -0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>While I was traveling to many of these countries, helping impoverished people, I saw first hand
      just how big of an impact these donations can make.</span></p><sup><a href="#cmnt43"
      id="cmnt_ref43">[aq]</a></sup><sup><a href="#cmnt44" id="cmnt_ref44">[ar]</a></sup>
  <p><span
      style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 222.67px; height: 57.41px;">
<picture>
        <source srcset="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image20.jpg" type="image/jpg">
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image20.png"
        style="width: 222.67px; height: 57.41px; margin-left: -0.00px; margin-top: -0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
        class="float-right md:ml-4 mb-3 w-full md:w-2/5" title="">
</picture>
</span></p>
  <p><span>The vitamins we can get with the money from your order today will give multiple kids a
    </span><span class="font-bold">better chance to grow up</span><span class="font-bold">&nbsp;</span><span class="font-bold">healthy and
      strong</span><span>, and allow them to lead much better lives&hellip;</span></p>
  

  <p><span>And so if you order, I will </span><span class="font-bold">thank you personally</span><span
      >&nbsp;for your gift today.</span></p>
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3l18frh"><span>There Are Really Only </span><span class="font-bold">Two Places</span><span
      class=" ">&nbsp;Left To Go From Here&hellip;</span></h2>
  ...
  <p><span>You may become even more forgetful and </span><span class="font-bold">un</span><span
      >focused&hellip;</span></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.206ipza"><span class=" ">Most Experts And Doctors Won&rsquo;t Tell You What I&rsquo;ve
  ...
  <p><span>Helping you to </span><span class="font-bold">feel more mentally energized</span><span>, </span><span
      class="font-bold">focused,</span><span>&nbsp;and </span><span class="font-bold">youthful</span><span>.</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.4k668n3"><span class=" ">All you need to get started is to click the button below:</span>
  </h3>
  ...
  <p><span>But also to a stronger memory, more </span><span class="font-bold">mental energy</span><span>,
    </span><span class="font-bold">focus,</span><span>&nbsp;and being </span><span class="font-bold">more capable</span><span
      >&hellip;</span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2zbgiuw"><span>I believe this can be</span><span class="font-bold">&nbsp;one of the most important
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.1egqt2p"><span>There Is </span><span class="font-bold">No Reason </span><span>For You To Spend The Next
      5 Or 10 Years (Or Longer) Dealing With</span><span class="font-bold">&nbsp;Brain Fog</span><span>, Feeling </span><span
      class="font-bold">Forgetful</span><span>, And </span><span class="font-bold">Worn Down</span><span class=" ">&nbsp;If You
      Don&#39;t Have To&hellip;</span></h2>
...
<img alt="" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/wsl/image25.png"
...
</span><sup><a href="#cmnt45" id="cmnt_ref45">[as]</a></sup></p>
  ...
  <h2 class="text-2xl md:text-4xl text-rpblue mb-4 title text-center md:text-left mt-6 md:mt-11" id="h.3ygebqi"><span>All the work has been done for you.</span></h2>
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.sfh926oxyqo9"><span class="   font-bold">All you need to do now is just click the button
      below:</span></h3>
  ...
  <p><span>All you need to do is </span><span class="font-bold">click the button below</span><span
      >&nbsp;now </span></p>
  ...
  <h3 class="text-center text-lg md:text-2xl my-4 md:my-8"  id="h.2dlolyb"><span class="   font-bold">And change can happen at any age</span></h3>
  <p><span class="  "></span></p>
