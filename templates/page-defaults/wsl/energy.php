...
<head>
    ...
    <title><?= $company['name']; ?> - This Secret Holds The Key To Endlessly Energy</title>
    <style>
    .wsl p, h1, h2 {
      margin-bottom: 20px;
    }
...
<body class="bg-gray-100 c8">
  ...
  <div class="flex justify-center">
    <img class="w-full mx-auto" src="//<?= $_SERVER['HTTP_HOST']; ?>/images/dr-computer.jpg" alt="doctors research" loading="lazy"/>
  </div>
