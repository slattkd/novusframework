    ...
    <div class="container mx-auto py-8">	
		<div class="content px-5">
            <div class="w-full md:w-full p-4">
                ...
                <p>The following Privacy Policy governs the online information collection practices of <?php echo $company['name'] ?> of ("we" or "us"). Specifically, it outlines the types of information that we gather about you while you are using the fatreleaseswitch.com website (the "Site"), and the ways in which we use this information. This Privacy Policy, including our children's privacy statement, does not apply to any information you may provide to us or that we may collect offline and/or through other means (for example, at a live event, via telephone, or through the mail).</p>
                ...
                <p>To make any of these requests, please contact our GDPR contact: <a href="mailto:<?php echo $company['email']?>"><?php echo $company['email']?></a></p>
                ...
                <p>To make these requests, please contact our CCPA contact at <a href="mailto:<?php echo $company['email']?>"><?php echo $company['email']?></a>.</p>
                ...
                <p>Because we do not collect any personally identifiable information from children under the age of thirteen as part of the Site, we also do NOT knowingly distribute such information to third parties.
                    We do NOT knowingly allow children under the age of thirteen to publicly post or otherwise distribute personally identifiable contact information through the Site.
                    Because we do not collect any personally identifiable information from children under the age of thirteen as part of the Site, we do NOT condition the participation of a child under thirteen in the Site's online activities on providing personally identifiable information.</p>
