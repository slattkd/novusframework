...
<section>
  <div class="flex w-full funnel-progress bg-white rounded mb-7 sans">
      <div class="funnel-progress-step w-1/3 <?php if ($current_step == 1) echo 'bg-yellow-50'; ?>">
      ...
      <div class="funnel-progress-step w-1/3 <?php if ($current_step == 2) echo 'bg-yellow-50'; ?>">
      ...
      <div class="funnel-progress-step w-1/3 <?php if ($current_step == 3) echo 'bg-yellow-50'; ?>">
