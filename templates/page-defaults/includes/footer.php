...
<footer class="bg-zinc-700">
	<div class="container container-md mx-auto py-6">
		<div class="grid grid-cols-2 gap-10 sm:gap-8 sm:grid-cols-4 ml-6">
			<div>
				<h3 class="mb-2 w-full text-sm font-semibold text-gray-900 uppercase dark:text-white">Supernatural Man LLC.</h3>
				<ul class="w-full">
					...
					<ul class="">
						<li class="mb-1">
							<div class="flex items-center">
								...
								<a href="/tailwind/5gmale-t.php" target="_blank" class="ml-2 text-gray-400 hover:text-white hover:underline transition duration-150 ease-in-out cursor-pointer">5G Male</a>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="flex md:justify-center">
				<div class="flex flex-col -ml-3 md:ml-0">
					<a href="#" target="_blank" class="flex items-center">
						<img src="/images/gmp.png" class="mr-4" alt="Supernatural Logo" style="max-width: 150px">
					</a>
				</div>
			</div>
		</div>
	...
	<div class="w-full bg-zinc-800 pb-4">
		<div class="flex flex-wrap items-center justify-center md:justify-between container container-md mx-auto text-sm p-2">
			...
			<div class="flex items-center mt-4 space-x-6 justify-center">
				<a href="/tailwind/support.php" class="text-gray-400 hover:text-white transition duration-150 ease-in-out cursor-pointer">CONTACT US</a>
