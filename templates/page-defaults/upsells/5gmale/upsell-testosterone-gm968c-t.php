		...
		<div class="content px-1">
			...
			<section>
				<div class="p-3 md:p-5 bg-white rounded">
					...
					<p class='text-center px-5 split-non-buy processlink text-gray-500 font-sm'><a href="downsell-3" style="color: #8C8C8C; text-decoration:underline;" onclick="exit=false;">Skip This</a> - Yes, Ryan, I understand this deep discount is only available on this page and once I leave it will be gone for good. Please give my discount away to another man.</p>
					</div>
