					...
					<div id="order-section" style="display:none;">
						...
						<div class="flex w-full flex-wrap justify-around border-2 border-red-600 border-dashed" >
							<div class="flex flex-col justify-around p-4">
								...
								<a href="/OCUS/?id=2" id="upsell-buy" class="buy_button processlink" rel="samewin" onclick="exit=false;"><img class="mx-auto" src="//5gm.s3.amazonaws.com/yes-secure-my-discount.png" alt="Yes, Secure My Discount" style="max-width: 300px" /></a>
								</div>
