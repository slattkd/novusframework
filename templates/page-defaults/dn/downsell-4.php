		...
		<div class="content px-1">
			...
			<div class="flex-flex-col w-full p-3 md:p-5 lg:p-10 bg-white rounded border border-black">
				...
				<div class="flex flex-col w-full">
					...
					<p class="w-full pb-4">I really want to make sure you can make a hot girl scream your name with pleasure… and give her multiple, toe-curling orgasms again and again&hellip;</p>
					<p class="w-full pb-4">So right now, today only…</p>
					<p class="w-full pb-4">I’ll send you a smaller, three-bottle supply of Supernatural Man’s O.X. Gel and give you an <strong><em>even bigger discount</em></strong>.</p>
					<p class="w-full pb-4">On the last page, you got a 59% OFF discount&hellip;</p>
				</div>
				...
				<?php } else { ?>
						<h2 class="text-red-600 text-2xl text-center my-7">Now I’ll Drop The Price EVEN MORE&hellip; And Give You <strong>3 Bottles of O.X. Gel for just $15.98 each!</strong></h2>
				<?php } ?>
				...
				Secure Your <strong>EXTREME DISCOUNT</strong> On A <?php echo $supply; ?>-Month Supply of Supernatural Man’s O.X. Gel And <strong>Get <?php echo $savings; ?>% OFF!</strong>
				</h2>
				...
				<div class="flex w-full justify-center py-7">
					<p class='text-center px-5 split-non-buy processlink text-gray-500 text-sm'><a  href="//<?php echo $_SERVER['HTTP_HOST']?>/thank-you" style="color: #8C8C8C; text-decoration:underline;" onclick="exit=false;">Skip This</a> - No, Ryan I don’t want this, I understand what a great deal this is and I am giving up my chance to have it, please give my discount to the man in line.</p>
				</div>
