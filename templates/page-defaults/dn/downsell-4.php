...
$_SESSION['pageType'] = 'dn4';
         ...
         <div id="letter_body" class=" pr-4 pl-42  md:w-full pr-4 pl-42 flex flex-wrap">
             ...
             <div class="letter-body">
                 ...
                 <!-- PASTE LETTER HERE -->
                     ...
                     <!--p class="p4 flex-gflex flex-wrapor-black"><b><span id="upSellName" style="font-size: 17px;"><strong style="flex-growor: #D81E00;">WARNING:</strong> <u>Do Not</u> Leave This Page Yet, Your Order Is Not Complete!</span></b></p-->
                     <p class="p2"><br></p>
                     ...
                     <p class="p2"><br></p>
                     <p class="p3">I really want to make sure you can make a hot girl scream your name with pleasure… and give her multiple, toe-curling orgasms again and again&hellip;</p>
                     <p class="p2"><br></p>
                     <p class="p3">So right now, today only…</p>
                     <p class="p2"><br></p>
                     <p class="p3">I’ll send you a smaller, three-bottle supply of Supernatural Man’s O.X. Gel and give you an <strong><em>even bigger discount</em></strong>.</p>
                     <p class="p2"><br></p>
                     <p class="p3">On the last page, you got a 59% OFF discount&hellip;</p>
                     <p class="p2"><br></p>

                     <?php if($newflow) { ?>
                         <p class="p4 centered">Now I’ll Drop The Price EVEN MORE… And Give You A <strong>WHOPPING <?php echo $savings; ?>% OFF!</strong></p>
                     <?php } else { ?>
                         <p class="p4 centered">Now I’ll Drop The Price EVEN MORE&hellip; And Give You <strong>3 Bottles of O.X. Gel for just $15.98 each!</strong></p>
                     <?php } ?>
 ...
 <p class="p4 centered" style="font-size:35px;">Secure Your <strong>EXTREME DISCOUNT</strong> On A <?php echo $supply; ?>-Month Supply of Supernatural Man’s O.X. Gel And <strong>Get <?php echo $savings; ?>% OFF!</strong></p>
 <p class="p2"><br></p>
     ...
     <div id="container-buy" style="">
             <div class="options">
                 <div class="option1">
                     ...
                     <?php if($newflow) { ?>
                         <center><span><a href="//<?php echo $_SERVER['HTTP_HOST']?>/process-up?pid=756&buy=1&next=thank-you" id="upsell-buy2" class="buy_button processlink" rel="samewin">Yes, Secure My Discount!</a></span></center>
                     <?php } else { ?>
                         <center><span><a href="//<?php echo $_SERVER['HTTP_HOST']?>/process-up?pid=755&buy=1&next=thank-you" id="upsell-buy2" class="buy_button processlink" rel="samewin">Yes, Secure My Discount!</a></span></center>
                     <?php } ?>
                     </div>
                 </div>
 ...
 <script type="text/javascript">
     ...
     <?php if($detect->isMobile()) { ?>
         var stateObj = { };
         history.pushState(stateObj, "100% SECURE - Supernatural Man LLC Checkout", "downsell-4-t.php<?php echo $querystring;?>");
 ...
 <script>
     var specialOffer = 'downsell-4-t.php<?php echo trim($querystring); ?>';
 </script>
