...
?>
 ...
 <div class="main_container">
     <div class="slpage">
         ...
         <!-- <div class="step-bar lefts" style="margin-bottom:10px;">

             <ul>
                 <li class="step-1"><span>Step 1: Secure Your Spot</span></li>
                 <li class="step-2"><span>Step 2: Get Instant Access</span></li>
                 <li class="step-3"><span>  Step 3: Get Rock Hard Results!</span></li>
             </ul>
             ...
             <section>
                 ...
                 <div id="letter_body" class="sm:w-full pr-4 pl-4 sm:w-full pr-4 pl-4 flex flex-wrap ">

 <div class="letter-body">

     <!-- PASTE LETTER HERE -->

         <!--p class="p4 color-black"><b><span id="upSellName" style="font-size: 17px;"><strong style="color: #D81E00;">WARNING:</strong> <u>Do Not</u> Leave This Page Yet, Your Order Is Not Complete!</span></b></p-->
         <p class="p2"><br></p>

         <p class="p4 centered" style="font-size:55px; line-height: 58px;">Take Just <?php echo $supply; ?> Bottles And Get An Even <strong>BIGGER Discount…</strong></p>
         ...
         <p class="p2"><br></p>
         <p class="p3">I really want to make sure you maximize your testosterone production so that you become a raging bull in bed hot girls can’t resist&hellip;</p>
         <p class="p2"><br></p>
         <p class="p3">So right now, today only…</p>
         <p class="p2"><br></p>
         <p class="p3">I’ll send you a smaller, three-bottle supply Supernatural Man’s T3 and give you an <strong><em>even bigger discount</em></strong>.</p>
         <p class="p2"><br></p>
         <p class="p3">On the last page, you got a <?php echo $savings; ?>% OFF discount&hellip;</p>
         <p class="p2"><br></p>
         <?php if($newflow) { ?>
             <p clas="p4 centered">Now I’ll Drop The Price EVEN MORE… And Give You A WHOPPING <?php echo $savings; ?>% OFF!</p>
         <?php } else { ?>
             <p class="p4 centered">Now I’ll Drop The Price EVEN MORE&hellip; And Give You <strong>3 Bottles of T3 for just $32.65 each!</strong></p>
         <?php } ?>
         <p class="p2"><br></p>
 ...
 <p class="p4 centered" style="font-size:35px;">Secure Your <strong>EXTREME DISCOUNT</strong> On A <?php echo $supply; ?>-Month Supply of Supernatural Man’s T3 And <strong>Get <?php echo $savings; ?>% OFF!</strong></p>
 <p class="p2"><br></p>
 ...
 <div class="options">
         ...
         <?php if($newflow) { ?>
             <center><span><a href="//<?php echo $_SERVER['HTTP_HOST']?>/process-up?pid=752&buy=1&next=up/upsell-final-offer" id="upsell-buy2" class="buy_button processlink" rel="samewin">Yes, Secure My Discount!</a></span></center>
         <?php } else { ?>
             <center><span><a href="//<?php echo $_SERVER['HTTP_HOST']?>/process-up?pid=751&buy=1&next=up/upsell-final-offer" id="upsell-buy2" class="buy_button processlink" rel="samewin">Yes, Secure My Discount!</a></span></center>
         <?php } ?>
         </div>
         </div>
         ...
         <p class="centered  flex justify-center"><img class="guarantee" src="//<?php echo $_SERVER['HTTP_HOST']?>/images/90-day-icon.png" style="width:114px; height:112px;margin:0 auto;margin-top:20px;"></p>
 ...
 <p class="p2"><br></p>
                     ...
                     <p class = 'centered p8' style="font-size: 13px; color: #8C8C8C;"><a href="//<?php echo $_SERVER['HTTP_HOST']?>/up/upsell-final-offer" style="color: #8C8C8C; text-decoration:underline;" class="processlink">Skip This</a> - No, Ryan I don’t want this, I understand what a great deal this is and I am giving up my chance to have it, please give my discount to the man in line. </p>
 ...
 <script>
     ...
     <?php if($detect->isMobile()) { ?>
         var stateObj = { };
         history.pushState(stateObj, "100% SECURE - Supernatural Man LLC Checkout", "downsell-3-t.php<?php echo $querystring;?>");
 ...
 <script>
     var specialOffer = 'downsell-3-t.php<?php echo trim($querystring); ?>';
 </script>
