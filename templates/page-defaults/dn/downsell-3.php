 ...
 <div class="container container-vsl mx-auto py-8">
        ...
        <section>
			...
			<div class="flex-flex-col w-full p-3 md:p-5 lg:p-10 bg-white rounded border border-black">
				<p class="w-full text-center text-5xl text-red-500 mb-6">Take Just <?php echo $supply; ?> Bottles And Get An Even <strong>BIGGER Discount…</strong></p>
				<div class="flex flex-col w-full">
					...
					<p class="w-full pb-4">I really want to make sure you maximize your testosterone production so that you become a raging bull in bed hot girls can’t resist&hellip;</p>
					<p class="w-full pb-4">So right now, today only…</p>
					<p class="w-full pb-4">I’ll send you a smaller, three-bottle supply Supernatural Man’s T3 and give you an <strong><em>even bigger discount</em></strong>.</p>
					<p class="w-full pb-4">On the last page, you got a <?php echo $savings; ?>% OFF discount&hellip;</p>
				</div>

				<?php if($newflow) { ?>
					<h2 class="text-red-600 text-2xl text-center my-7">Now I’ll Drop The Price EVEN MORE… And Give You A WHOPPING <?php echo $savings; ?>% OFF!</strong></h2>
				<?php } else { ?>
						<h2 class="text-red-600 text-2xl text-center my-7">Now I’ll Drop The Price EVEN MORE&hellip; And Give You <strong>3 Bottles of T3 for just $32.65 each!</strong></h2>
				<?php } ?>
				...
				Secure Your <strong>EXTREME DISCOUNT</strong> On A <?php echo $supply; ?>-Month Supply of Supernatural Man’s T3 And <strong>Get <?php echo $savings; ?>% OFF!</strong>
				</h2>
				...
				<div class="flex w-full justify-center py-7">
					<p class='text-center px-5 split-non-buy processlink text-gray-500 text-sm'><a href="//<?php echo $_SERVER['HTTP_HOST']?>/up/upsell-final-offer" style="color: #8C8C8C; text-decoration:underline;" onclick="exit=false;">Skip This</a> - No, Ryan I don’t want this, I understand what a great deal this is and I am giving up my chance to have it, please give my discount to the man in line.</p>
				</div>
