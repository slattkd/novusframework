...
if (mt_rand(0,1) == 0) {
    header('Location: https://novusframework.com/wsl/energy' . $querystring);
    exit;
} else {
    header('Location: https://novusframework.com/wsl/memory' . $querystring);
    exit;
}
          ...
          <div class="flex flex-col">
            ...
            <p class="mt-3 text-base text-gray-300 text-center">
              We have a variety of products that can help your needs.
				 ...
				 <a href="/product" class="flex justify-center underline text-gray-500 text-center clickable pt-4 mt-auto">LEARN MORE</a>
          </div>
